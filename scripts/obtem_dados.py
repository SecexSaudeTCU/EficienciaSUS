...
def obtem_dados_dea(db_name, db_user, db_password, first_year=2017, last_year=2019):
...
def obtem_dados_clusterizacao(db_name, db_user, db_password, first_year=2017, last_year=2019):
...
def obtem_dados(db_name, db_user, db_password, first_year=2017, last_year=2019):

    obtem_dados_dea(db_name, db_user, db_password, first_year, last_year)
    obtem_dados_clusterizacao(db_name, db_user, db_password, first_year, last_year)



if __name__ == '__main__':

    obtem_dados('dbsus', 'Eric', 'teste', 2017, 2019)
