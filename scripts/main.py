...
def main_range(DATABASE_URI, first_period='01-2017', last_period='12-2019'):
    ...
    obtem_dados(DATABASE_URI, first_period, last_period)
...
if __name__ == '__main__':
    ...
    if tipo == '1':
        ...
        from obtem_dados_specific import obtem_dados

        main_specific(DATABASE_URI, 2019)

    else:

        from obtem_dados_range import obtem_dados
